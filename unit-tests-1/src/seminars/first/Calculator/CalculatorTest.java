...
public class CalculatorTest {
    public static void main(String[] args) {
        ...
        //Задание 1. **
        if (0 != Calculator.calculatingDiscount(0,0)) {
            throw new AssertionError("Ошибка в методе");
        }
        if (1 != Calculator.calculatingDiscount(1,0)){
            throw new AssertionError("Ошибка в методе");
        }
        if (0 != Calculator.calculatingDiscount(0,1)){
            throw new AssertionError("Ошибка в методе");
        }
        if (0 != Calculator.calculatingDiscount(500,100)){
            throw new AssertionError("Ошибка в методе");
        }
        if (0 != Calculator.calculatingDiscount(500,101)){
            throw new AssertionError("Ошибка в методе");
        }
        if (0 != Calculator.calculatingDiscount(-1,100)){
            throw new AssertionError("Ошибка в методе");
        }
